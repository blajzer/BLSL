	...
	fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		write!(f, "{}",
			match self {
				...
				BinaryOperator::BitXor => "bitwise exclusive-or",
				BinaryOperator::BitShiftLeft => "bit shift left",
				BinaryOperator::BitShiftRight => "bit shift right",
				BinaryOperator::Equal => "equal",
				BinaryOperator::NotEqual => "not equal",
				BinaryOperator::LessThan => "less than",
				BinaryOperator::LessThanEqual => "less than or equal",
				BinaryOperator::GreaterThan => "greater than",
				BinaryOperator::GreaterThanEqual => "greater than or equal",
				BinaryOperator::MemberAccess => "member access",
				BinaryOperator::ArrayAccess => "array access"
			}
		)
    }
}
